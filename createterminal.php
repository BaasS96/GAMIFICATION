...
//write data to file
$data = array("terminalcode" => $newterminalcode, "certificatenumber" => $certnum, "questionnumber" => $questnum, "idletext" => $idletext, "activated" => "0", "inuse" => "0", "groupid" => "", "exptime" => "", "qtype" => "", "question" => "", "answers" => array(""));
